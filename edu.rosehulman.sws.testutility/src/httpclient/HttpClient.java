...
public class HttpClient extends javax.swing.JFrame {
    ...
    private void butGeneratePersistentActionPerformedGET(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butGeneratePersistentActionPerformed
        StringBuffer buffer = new StringBuffer();
        //buffer.append("GET /index.html HTTP/1.1\r\n");
        buffer.append("GET /test1.txt HTTP/1.1\r\n");
    ...
    private void butGeneratePersistentActionPerformedPUT(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butGeneratePersistentActionPerformed
        StringBuffer buffer = new StringBuffer();
        buffer.append("PUT /test1.txt HTTP/1.1\r\n");
        ...
        buffer.append("\r\n");
        buffer.append("This is test1\r\n");
        //buffer.append("\r\n");
        this.txtRequest.setText(buffer.toString());
    }
    private void butGeneratePersistentActionPerformedPOST(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butGeneratePersistentActionPerformed
        StringBuffer buffer = new StringBuffer();
        buffer.append("POST /test2.txt HTTP/1.1\r\n");
        ...
        buffer.append("Content-Length: 15\r\n");
        buffer.append("\r\n");
        buffer.append("This is test2\r\n");
        //buffer.append("\r\n");
        this.txtRequest.setText(buffer.toString());
    }
    private void butGeneratePersistentActionPerformedDELETE(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butGeneratePersistentActionPerformed
        StringBuffer buffer = new StringBuffer();
        buffer.append("DELETE /test1.txt HTTP/1.1\r\n");
